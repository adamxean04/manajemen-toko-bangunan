    ...
    <div class="card small mb-3">
        ...
        <div class="card-body p-2">
            ...
            if(isset($_POST['alamat_pelanggan']))
            {
                ...
                if ($tambahPel){
                    echo '<script>alert("Tambah Data Pelanggan Berhasil");window.location="home.php"</script>';
                } else {
...
<div class="col-lg-9" id="print">
    ...
    <div class="row print-none">
        ...
        <div class="col-lg-3">
            ...
            <div class="input-group-append">
                <button class="btn btn-danger btn-sm border-0" type="reset">Reset</button>
            </div>
            </div>
        </div>
    </div><!-- end row -->
...
if(isset($_POST['tambahcuy'])){
    ...
    if ($stock < $quantity) {
    echo '<script>alert("Oops! Jumlah pengeluaran lebih besar dari stok ...");window.location="home.php"</script>';
    }   
    else{
                            ...
                            //proses    
                                ...
                                $insert1 = mysqli_query($conn, "UPDATE produk SET stock='$sisa1' WHERE idproduk='$idproduk'");
                                    if($insert1){
                                        ...
                                        echo '<script>alert("Data Berhasil Di Hapus");window.location="home.php"</script>';
                                    } else {
                    ...
                    <div class="row">
                        <div class="col-lg-5 mb-2 print-none">
                            ...
                            <div class="col-12 text-right pr-0 mt-2">
                                <button type="button" class="btn btn-light btn-sm px-3"  onclick="document.title='Invoice#<?php echo $kodeCart ?>';window.print()">Cetak</button>
                                <button type="reset" class="btn btn-danger btn-sm px-3">Reset</button>
                                <button type="submit" name="save" class="btn btn-primary btn-sm px-3">Simpan</button>
                            </div>
                        </div>
                    </div><!-- end row -->
                </form>
