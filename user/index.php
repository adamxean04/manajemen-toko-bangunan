...
// Query untuk mengambil data karyawan yang hanya memiliki role 'user'
$query_karyawan = "SELECT idkaryawan, namakaryawan FROM karyawan WHERE role = 'user'";
$result_karyawan = mysqli_query($conn, $query_karyawan);
...
<head>
    ...
    <title>Halaman Penjualan - user</title>
...
<body class="bg-light">
    <?php include "header.php"; // Memasukkan header untuk user ?>
    ...
    <script>
        ...
        function saveTransaction() {
            ...
            fetch('save_detail_transaksi.php', {
                method: 'POST',
                headers: {
        ...
        $(document).ready(function() {
            $('#simpanTransaksi').click(function() {
                ...
                $.post('save_transaksi.php', formData, function(response) {
                    if (response.success) {
